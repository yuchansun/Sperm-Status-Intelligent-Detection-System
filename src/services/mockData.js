...
export const historyRecords = [
  ...
  },
  {
    ...
    summary: '精子濃度偏低，型態比例仍需追蹤。',
    aiResult: { precision: '90%', confidence: '84%', processingTime: '1.0s' },
    trend: [10.8, 11.4, 12.6],
  },
  {
    id: 'P-2026-0615',
    sampleId: 'SP-20260615-06',
    date: '2026-06-15',
    status: '異常',
    score: '10.9M/mL',
    density: '10.9',
    ...
    summary: '精子濃度與活動力偏低，建議持續追蹤。',
    aiResult: { precision: '89%', confidence: '82%', processingTime: '1.1s' },
    trend: [9.8, 10.4, 10.9],
  },
]
